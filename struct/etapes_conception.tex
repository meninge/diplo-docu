...
% Liens entre l'IP et le C (DDR, DMA, nombre de burts)
% registres de contrôle
% allocation de tableaux alignées sur 16 * 4 octets (taille d'un burst)
% adresse du tableau et nombre de bursts (clear nécessaire)
% mode différent (configuration de chaque étage / frame)
% phases de débug avec des printf et des POP de chaque étage
% utilisation du cache (invalidate nécessaire)
% tests avec des petites frames, peu de neurones, peu de poids
